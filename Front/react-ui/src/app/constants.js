...
export const PROJECT_INFO_ID = "project-info-v121";
...
export const PROJECT_INFO = {
	...
	version: "V12.1",
	features: [
		"支持点赞、转发、评论三类互动能力，并接入后端持久化。",
		"Info 面板完成移动端、微信端排版收口，提升阅读空间与操作一致性。",
		"转发海报重做为正式分享样式，支持二维码预生成与直接进入保存图流程。",
	],
	info: "面向工作场景的企业智能问答与信息检索助手。",
	versionChange: "本版本继续聚焦前端体验收口，移除微信分享失败提示文案，保留直接生成图片流程，并同步更新版本信息至 V12.1。",
};
